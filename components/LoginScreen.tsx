...
export const LoginScreen: React.FC = () => {
  ...
  const [view, setView] = useState<'signIn' | 'signUp' | 'checkEmail'>('signIn');
      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-900 shadow-xl rounded-lg p-8 space-y-6">
        <div className="text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">
              {view === 'signIn' ? 'Connexion à Dr Samy' : 'Créer un compte'}
            </h1>
            <p className="text-gray-600 dark:text-gray-300">
              Accédez à votre assistant de pré-diagnostic.
            </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? 'Chargement...' : (view === 'signIn' ? 'Se connecter' : 'S\'inscrire')}
            </button>
        </form>
